...
/*
|--------------------------------------------------------------------------
| Linhas de tradução de validação (pt-BR)
|--------------------------------------------------------------------------
|
| Mensagens padrão das regras de validação do Laravel em português do Brasil.
| O `:attribute` é substituído pelo nome amigável do campo (ver `attributes`).
|
*/
...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'cnh_expiration' => 'validade da CNH',
        'phone' => 'telefone',
    ],

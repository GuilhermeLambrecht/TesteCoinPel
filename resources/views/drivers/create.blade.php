<x-layouts.app title="Novo motorista" heading="Motoristas">
    <x-drawer title="Novo motorista" :close-url="route('drivers.index')">
        <form method="POST" action="{{ route('drivers.store') }}" enctype="multipart/form-data" class="flex min-h-0 flex-1 flex-col">
            @csrf
